                                    ...
                                    <div class="relative overflow-x-auto">
                                        ...
                                        <body>
                                            ...
                                            <div class="grid-container">
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('dorms') }}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="private-schools-foxcroft02-1030x773.jpg"
                                                            alt="Cadinal Otunga">
                                                        <h3>Cadinal Otunga</h3>
                                                        {{-- <p>Class President</p> --}}
                                                    </div>
                                                </a>
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('lakeview') }}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="boarding-department-s.jpg" alt="Lake view">
                                                        <h3>lake view</h3>
                                                        {{-- <p>Student Council Treasurer</p> --}}
                                                    </div>
                                                </a>
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('mountainview')}}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="654476206-H.jpg" alt="Mountain View">
                                                        <h3>Mountain view</h3>
                                                ...
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('cityview') }}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="download (3).jpeg" alt="City View">
                                                        <h3>City View</h3>
                                                ...
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('mojadom') }}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="images.jpeg" alt="Moja Dom">
                                                        <h3>Moja Dom</h3>
                                                        {{-- <p>Drama Club President</p> --}}
                                                    </div>
                                                </a>
                                                <a class=" no-underline text-gray-50 hover:text-yellow-400 hover:uppercase"
                                                    href="{{ route('hillmalayas') }}">
                                                    <div class="grid-item">
                                                        <img class=" h-52" src="256.jpeg" alt="Hill Malayas">
                                                        <h3>Hill malayas</h3>
                    ...
                    <footer class="  px-4 bg-gray-900 sm:p-6 dark:bg-gray-900 pl-0 ml-0 ">
                        <div class=" ">
                            <div class="mb-6 md:mb-0 pb-8">
                                <a href="#" class="flex items-center">
                                    ...
                                    <span
                                        class="self-center text-2xl font-semibold whitespace-nowrap text-yellow-300">JRMHD</span>
                                </a>
                            </div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            ...
                            <li>
                                ...
                                <div>
                                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-yellow-300">
                                        Departments</h2>
                                ...
                                <div>
                                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-yellow-300">Follow us
                                    </h2>
                                    <ul class="text-gray-600 dark:text-gray-400 text-left pl-0 ml-0">
                                        <li class="mb-4">
                                ...
                                <div>
                                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-yellow-300">Legal
                                    </h2>
                                    <ul class="text-gray-600 dark:text-gray-400 text-left pl-0 ml-0">
                                        <li class="mb-4">
                                            <a href="#"
                                                class="hover:text-yellow-300 no-underline text-gray-50">Privacy
                                                Policy</a>
                                        </li>
                                        <li>
