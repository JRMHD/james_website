                                        ...
                                        <table class="table-fixed w-full text-white">
                                          <thead>
                                            <tr>
                                              ...
                                              <th class="w-1/3">Teacher</th>
                                              <th class="w-1/3">Number of Students</th>
                                            </tr>
                                          </thead>
                                          <tbody>
                                            <tr>
                                              <td class="px-4 py-2">ICT</td>
                                              <td class="px-4 py-2">Reagan</td>
                                              <td class="px-4 py-2">25</td>
                                            </tr>
                                            <tr>
                                              <td class="px-4 py-2">Business</td>
                                              <td class="px-4 py-2">Mercy</td>
                                              <td class="px-4 py-2">30</td>
                                            </tr>
                                            <tr>
                                              <td class="px-4 py-2">Science</td>
                                              <td class="px-4 py-2">Shalom</td>
                                              <td class="px-4 py-2">20</td>
                                            </tr>
                                            <tr>
                                              <td class="px-4 py-2">Computer studies</td>
                                              <td class="px-4 py-2">Steve</td>
                                              <td class="px-4 py-2">22</td>
                                            </tr>
                                            <tr>
                                              <td class="px-4 py-2">Perazim</td>
                                              <td class="px-4 py-2">Mukabana</td>
