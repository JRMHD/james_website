                ...
                <div class="pb-4 bg-gray-800 dark:bg-gray-900">
                    <div>
                        <div class="bg-gray-800 p-4">
                            <h1 class="text-white font-bold text-lg mb-4">Attendance Rate</h1>
                            <ul class="list-disc list-inside">
                              <li class="text-gray-300">Reagan: 90%</li>
                              <li class="text-gray-300">Shalom: 95%</li>
                              <li class="text-gray-300">Mercy: 92%</li>
                              <li class="text-gray-300">Steve: 85%</li>
                              <li class="text-gray-300">Perazim: 88%</li>
                            </ul>
                          </div>
