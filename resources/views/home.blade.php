...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-gray-900">
                        ...
                        <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                            <div
                                class=" border-solid border-zinc-800 border-2 bg-gray-800 rounded-2xl p-5 justify-center text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" class="mx-auto"
                                    viewBox="0 0 24 24">
                                    <g>
                                        <path
    ...
    <p <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://github.com/JRMHD"target="_blank" class="hover:underline ">Github</a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/" target="_blank" class="hover:underline">Instagram</a>
                    </li>
                    <li>
                    <a href="https://wa.me/254706378245" target="_blank">Whatsapp</a>
                    </li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#"
                class="hover:underline">Jrmhd™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/JRMHDD/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.instagram.com/techjrmhd/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
            ...
            <a href="https://twitter.com/Nairobigoat" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
            ...
            <a href="https://github.com/JRMHD" target="_blank"  class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
