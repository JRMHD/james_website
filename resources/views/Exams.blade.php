        ...
        <div class="row justify-content-center">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full bg-gray-800 text-white">
                    <thead>
                      <tr>
                        <th class="px-6 py-3 text-left uppercase font-semibold">Student Name</th>
                        <th class="px-6 py-3 text-left uppercase font-semibold">Exam Passed</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="px-6 py-4">Shalom</td>
                        <td class="px-6 py-4">Mathematics</td>
                      </tr>
                      <tr>
                        <td class="px-6 py-4">Reagan</td>
                        <td class="px-6 py-4">Physics</td>
                      </tr>
                      <tr>
                        <td class="px-6 py-4">Mercy</td>
                        <td class="px-6 py-4">Biology</td>
                      </tr>
                      <tr>
                        <td class="px-6 py-4">Xaviour</td>
                        <td class="px-6 py-4">Chemistry</td>
                      </tr>
                      <tr>
                        <td class="px-6 py-4">Steve</td>
